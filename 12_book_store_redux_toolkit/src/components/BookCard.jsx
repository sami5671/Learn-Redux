...
const BookCard = ({ book }) => {
  const { id, featured, thumbnail, rating, price, author, name } = book;
        ...
        <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
          <div className="flex items-center justify-between">
            ...
            <div className="text-gray-500 space-x-2">
              ...
              <button onClick={handleDeleteBook} className="lws-delete">
                {isLoading ? (
                  <ImSpinner10 className="animate-spin text-red-600 text-xl" />
                ) : (
                  <svg
                    fill="none"
                    viewBox="0 0 24 24"
          ...
          <div className="space-y-2 mt-4 h-full">
            ...
            <p className="lws-price">BDT {price}tk</p>
          </div>
        </div>
      </div>
    </>
